...
$dbss=array();
$dbss['host']='sql109.infinityfree.com';      // Database host (in most cases 'localhost', on Windows systems - use '127.0.0.1' instead of 'localhost' to avoid a php/ipv6 bug)
$dbss['user']='if0_35617431';      // Database user
$dbss['pass']='LyGovn8sVipc';      // Database password
$dbss['name']='if0_35617431_chat';      // Database name. Note that the installation script cannot create a database for you!
